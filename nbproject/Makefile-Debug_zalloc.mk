...
LDLIBSOPTIONS=../zalloc/bin/zallocd.so -lconfig

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk bin/zeroservd

bin/zeroservd: ../zalloc/bin/zallocd.so
