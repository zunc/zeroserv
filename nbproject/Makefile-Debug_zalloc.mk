...
${OBJECTDIR}/src/handler/http/http_parser.o: src/handler/http/http_parser.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/handler/http/http_parser.o src/handler/http/http_parser.c

${OBJECTDIR}/src/handler/http_pubsub.o: src/handler/http_pubsub.c 
	${MKDIR} -p ${OBJECTDIR}/src/handler
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/handler/http_pubsub.o src/handler/http_pubsub.c
...
${OBJECTDIR}/src/handler/pubsub.o: src/handler/pubsub.c 
	${MKDIR} -p ${OBJECTDIR}/src/handler
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/handler/pubsub.o src/handler/pubsub.c

${OBJECTDIR}/src/handler/pubsub/account.o: src/handler/pubsub/account.c 
	${MKDIR} -p ${OBJECTDIR}/src/handler/pubsub
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/handler/pubsub/account.o src/handler/pubsub/account.c

${OBJECTDIR}/src/handler/pubsub/idzen.o: src/handler/pubsub/idzen.c 
	${MKDIR} -p ${OBJECTDIR}/src/handler/pubsub
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/handler/pubsub/idzen.o src/handler/pubsub/idzen.c

${OBJECTDIR}/src/handler/pubsub/model.o: src/handler/pubsub/model.c 
	${MKDIR} -p ${OBJECTDIR}/src/handler/pubsub
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/handler/pubsub/model.o src/handler/pubsub/model.c

${OBJECTDIR}/src/handler/pubsub/topic.o: src/handler/pubsub/topic.c 
	${MKDIR} -p ${OBJECTDIR}/src/handler/pubsub
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/handler/pubsub/topic.o src/handler/pubsub/topic.c
