...
${OBJECTDIR}/src/handler/http/http_parser.o: src/handler/http/http_parser.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/handler/http/http_parser.o src/handler/http/http_parser.c

${OBJECTDIR}/src/handler/http_pubsub.o: src/handler/http_pubsub.c 
	${MKDIR} -p ${OBJECTDIR}/src/handler
	${RM} "$@.d"
	$(COMPILE.c) -g -Isrc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/handler/http_pubsub.o src/handler/http_pubsub.c
